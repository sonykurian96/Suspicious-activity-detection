...
def train_from_video(vid):
    ...
    np.save(r"E:\major_project\Unusual-Human-Activity-Detection\Dataset\videos\scene1\megaBlockMotInfVal_set1_p1_train_40-40_k5.npy",megaBlockMotInfVal)
    print(np.amax(megaBlockMotInfVal))
    print(np.amax(reject_outliers(megaBlockMotInfVal)))
    
    codewords = cmb.kmeans(megaBlockMotInfVal)
    np.save(r"E:\major_project\Unusual-Human-Activity-Detection\Dataset\videos\scene1\codewords_set1_p1_train_40-40_k5.npy",codewords)
    print(codewords)
    return
...
if __name__ == '__main__':
    ...
    '''
    trainingSet = [r"E:\major_project\Unusual-Human-Activity-Detection\Dataset\videos\scene1\train1.avi",r"E:\major_project\Unusual-Human-Activity-Detection\Dataset\videos\scene2\2_train3.avi"]
